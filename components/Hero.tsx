  ...
  return <section className="speaker-led-hero">
    <div className="summit-wrap">
      ...
      <div className="speaker-hero-grid">
        ...
        <img className="speaker-hero-art" src="https://assets.cdn.filesafe.space/OtOPsRWlrRPyLs03ZSTG/media/6ab5de1c974a9da6eeaf739c.jpeg" width="1600" height="900" fetchPriority="high" alt="AI Made Easy Summit speaker lineup: Kanji Low, Scott Simson, Austin Armstrong, Melissa Mitchell, Jeff Ross, Bruno and Stacie Marcinkowski, Louise Dutka and Dave Miller. Surfers Paradise, Gold Coast, 18 June 2027." />
      </div>
    </div>
