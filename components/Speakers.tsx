...
export default function Speakers() {
  ...
  const featured = ["kanji-low", "melissa-mitchell"].map((slug) => speakers.find((s) => s.slug === slug)!);
  ...
  return <section id="speakers" className="summit-section speaker-lineup">
    <div className="summit-wrap">
      ...
      <div className="lineup-featured">{featured.map((s) => <SpeakerCard key={s.slug} speaker={s} landscape />)}</div>
